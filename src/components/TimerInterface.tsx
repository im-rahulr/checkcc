...
const TimerInterface = ({
  ...
  return (
    <div
      className="backdrop-blur-sm bg-black/20 rounded-lg px-8 py-6 text-center max-w-md mx-auto"
      data-oid="8-d5j.p"
    >
      ...
      <div className="mb-6" data-oid="zuzm-ks">
        <div
          className="text-6xl md:text-7xl font-mono font-bold text-white tracking-widest"
          data-oid="93csmm7"
        >
          {formatTime(seconds)}
        </div>
      ...
      >
        ...
        <div className="flex items-center" data-oid="w1:k:jo">
          ...
          <div
            className="ml-2 w-12 h-6 bg-gray-600/50 rounded-full p-1 flex items-center"
            data-oid="h1ljg7n"
          >
            <div
      ...
      <div className="flex justify-center space-x-1" data-oid="a88docy">
        <Button
          variant="ghost"
          className="bg-blue-600/80 text-white hover:bg-blue-500/80 px-6 py-2 rounded-md"
          data-oid="i94-b36"
        >
          Code
        </Button>
        <Button
          variant="ghost"
          className="bg-gray-700/60 text-gray-300 hover:bg-gray-600/60 px-6 py-2 rounded-md"
          data-oid="5oqv2_2"
        >
          Market
        </Button>
